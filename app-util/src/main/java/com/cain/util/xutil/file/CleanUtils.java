...
package com.cain.util.xutil.file;
...
public final class CleanUtils {
    ...
    public static boolean cleanInternalCache() {
        return deleteFilesInDir(XUtil.getContext().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return deleteFilesInDir(XUtil.getContext().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return deleteFilesInDir(new File(XUtil.getContext().getFilesDir().getParent(), "databases"));
    }
    ...
    public static boolean cleanInternalDbByName(final String dbName) {
        return XUtil.getContext().deleteDatabase(dbName);
    }
    ...
    public static boolean cleanInternalSp() {
        return deleteFilesInDir(new File(XUtil.getContext().getFilesDir().getParent(), "shared_prefs"));
    }
    ...
    public static boolean cleanExternalCache() {
        return Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && deleteFilesInDir(XUtil.getContext().getExternalCacheDir());
    }
