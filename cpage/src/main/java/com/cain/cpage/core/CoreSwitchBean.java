...
/**
  * @Description:    页面跳转控制参数
  * @Author:         cain
  * @CreateDate:     2020/5/17 下午10:21
  * @Version:        1.0
 */
public class CoreSwitchBean implements Parcelable{
    ...
    public <T extends CPageFragment> CoreSwitchBean(Class<T> clazz, Bundle bundle) {
    ...
    public <T extends CPageFragment> CoreSwitchBean(Class<T> clazz) {
        PageInfo pageInfo = PageConfig.getPageInfo(clazz);
        mPageName = pageInfo.getName();
        setAnim(pageInfo.getAnim());
    }
     ...
     * @return
     */
    public CoreSwitchBean setContainActivityClazz(@NonNull Class<? extends CPageActivity> containActivityClazz) {
    ...
    public CoreSwitchBean setNewActivity(boolean newActivity, @NonNull Class<? extends CPageActivity> containActivityClazz) {
        mNewActivity = newActivity;
        mContainActivityClassName = containActivityClazz.getCanonicalName();
        return this;
    }
