...
import static com.cain.cpage.core.CoreSwitchBean.convertAnimations;

/**
  * @Description:    页面选项
  * @Author:         cain
  * @CreateDate:     2020/5/18 下午5:21
  * @Version:        1.0
 */
public class PageOption {
     ...
     * @return
     */
    public static <T extends CPageFragment> PageOption to(Class<T> clazz) {
    ...
    public <T extends CPageFragment> PageOption(Class<T> clazz) {
        setTargetPage(clazz);
    }
     ...
     * @return
     */
    public <T extends CPageFragment> PageOption setTargetPage(Class<T> clazz) {
    ...
    /**
     * 设置CPageFragment的容器Activity类名
     *
     * @param containActivityClazz
     * @return
     */
    public PageOption setContainActivityClazz(@NonNull Class<? extends CPageActivity> containActivityClazz) {
    ...
    public PageOption setNewActivity(boolean newActivity, @NonNull Class<? extends CPageActivity> containActivityClazz) {
        mNewActivity = newActivity;
        mContainActivityClassName = containActivityClazz.getCanonicalName();
        return this;
    }
     ...
     * @return
     */
    public Fragment open(@NonNull CPageFragment fragment) {
        return fragment.openPage(this);
    }

    /**
     * 在CPageFragment中使用，有返回值
     *
     * @param fragment
     * @param requestCode
     * @return
     */
    public Fragment openForResult(@NonNull CPageFragment fragment, int requestCode) {
     ...
     * @return
     */
    public Fragment open(@NonNull CPageActivity activity) {
