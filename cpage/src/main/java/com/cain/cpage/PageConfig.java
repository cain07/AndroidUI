...
public class PageConfig {
     ...
     */
    private String mContainActivityClassName = CPageActivity.class.getCanonicalName();
     ...
     * @return
     */
    public PageConfig setContainActivityClazz(@NonNull Class<? extends CPageActivity> containActivityClazz) {
