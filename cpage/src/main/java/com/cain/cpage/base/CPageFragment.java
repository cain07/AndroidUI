 ...
 */
public abstract class CPageFragment extends Fragment {
    /**
     * 所在activity
     */
    ...
    public CoreSwitcher getSwitcher() {
        synchronized (CPageFragment.this) {
     ...
     */
    public CPageFragment setSwitcher(CoreSwitcher pageCoreSwitcher) {
     ...
     * @return 打开的fragment对象
     */
    public <T extends CPageFragment> T openPage(Class<T> clazz, Bundle bundle, CoreAnim coreAnim) {
     ...
     * @return 打开的fragment对象
     */
    public final <T extends CPageFragment> T openPageForResult(Class<T> clazz, Bundle bundle, int requestCode) {
