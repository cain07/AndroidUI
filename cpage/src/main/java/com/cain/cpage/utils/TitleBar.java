...
public class TitleBar extends ViewGroup implements View.OnClickListener{
    ...
    private void initView(Context context) {
        ...
        addView(mDividerView, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, mDivideHeight));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (heightMode != View.MeasureSpec.EXACTLY) {
            ...
            heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(mBarHeight, View.MeasureSpec.EXACTLY);
        } else {
        ...
        if (mLeftText.getMeasuredWidth() > mRightLayout.getMeasuredWidth()) {
            mCenterLayout.measure(
                    View.MeasureSpec.makeMeasureSpec(mScreenWidth - 2 * mLeftText.getMeasuredWidth(), View.MeasureSpec.EXACTLY)
                    , heightMeasureSpec);
        } else {
            mCenterLayout.measure(
                    View.MeasureSpec.makeMeasureSpec(mScreenWidth - 2 * mRightLayout.getMeasuredWidth(), View.MeasureSpec.EXACTLY)
                    , heightMeasureSpec);
        }
