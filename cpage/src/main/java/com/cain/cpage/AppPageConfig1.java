 ...
 */
public class AppPageConfig1 {
  private static AppPageConfig1 sInstance;
  ...
  public static AppPageConfig1 getInstance() {
    if (sInstance == null) {
      synchronized (AppPageConfig1.class) {
        if (sInstance == null) {
          sInstance = new AppPageConfig1();
        }
      }
    }
    return sInstance;
